...
module.exports = {
    dev: {
        ...
        proxyTable: {
            '/clinbrain/api': {
                // 测试环境
                // target: "http://192.168.6.189:9999",  // 乐乐·接口域名
                // target: "http://localhost:9999",  // 乐乐·接口域名(华西)
                // target: "http://192.168.5.147:9999",  // 王益·接口域名
                // target: "http://192.168.0.191:9999",  // 王益·接口域名(华西)
        ...
        // Various Dev Server settings  我来 提交 试试
