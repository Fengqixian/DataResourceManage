<template>
    <div class="layout-header">
        <div class="logo">
            <img class="company" :src="`/static/images/hx-Theme-header-logo.png`" height="22px">
        ...
        <div class="user">
            ...
            <!--<el-dropdown>
            <span>{{userName}}</span>
            &lt;!&ndash;<span>{{userName}} <i class="el-icon-caret-bottom"></i></span>&ndash;&gt;
            &lt;!&ndash;<el-dropdown-menu slot="dropdown" class="layout-header-dropdown">&ndash;&gt;
            &lt;!&ndash;<el-dropdown-item @click.native.prevent.stop="dropdownMenuClick('exit')">退出</el-dropdown-item>&ndash;&gt;
...
<script lang="ts">
    ...
    export default class Index extends Vue {
        ...
        get userName() {
            return sessionStorage.getItem('usernamecn')
        }
